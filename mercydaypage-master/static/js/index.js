...
$('#popup-list-form-form').submit(function () {
    // submit the form
    //data area
    var data = [];
    ...
    if ($(this).valid()) {
        ...
        $.ajax({
            ...
            processData: false,
            success: function () {
                $('#popup-list-form-form').find('[type=submit]').button('complete');
            },
            error: function () {
                $('#popup-list-form-form').find('[type=submit]').button('reset');
            }
        });
    } else {
            ...
            success: function (result) {
                ...
                if (result.error){
                    ...
                    if (document.getElementById('nameinput') !== "-"){
                        document.getElementById('btntitle').innerHTML = '<i class=" text-success card-icon icon-size-m icon-checkmark-circle"></i><span class="text-success h3">Вы успешно зарегистрированы!</span>';
                    }
                    else {
                    ...
                    // <i class=" text-success card-icon icon-size-m icon-checkmark-circle"></i><span class="text-success h3">Вы успешно зарегистрированы!</span>
                }
